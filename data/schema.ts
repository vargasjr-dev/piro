 ...
 * The architecture entrypoint lives in the repo (e.g. "architectures/ashfall/main.py").
...
export const trainingRun = pgTable(
  "training_run",
  {
    ...
    /** Path in the workspace to the architecture entrypoint (e.g. "architectures/ashfall/main.py"). */
