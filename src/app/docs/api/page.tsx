...
export default function ApiDocsPage() {
  return (
    <DocsShell active="/docs/api" title="API" compact>
      <div className="overflow-hidden rounded-3xl border border-amber-900/30 bg-[#13100c]">
        <div className="border-b border-amber-900/25 px-6 py-5 sm:px-8">
          <div className="flex flex-wrap items-center gap-3 font-mono text-sm">
            <span className="rounded-md bg-emerald-400/15 px-2.5 py-1 font-bold text-emerald-300">
              POST
            </span>
        ...
        <div className="grid gap-0 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.9fr)]">
          <section className="border-b border-amber-900/25 p-6 sm:p-8 lg:border-b-0 lg:border-r">
            ...
            <p className="mt-3 text-sm leading-relaxed text-amber-300/60">
              The request body is a PiroInput observation. PiroInput is an
              ordered packet of typed parts; text observations use a single{" "}
              <code className="text-amber-100">text</code> part.
            </p>
            ...
            <div className="mt-7">
              ...
              <dl className="mt-4 divide-y divide-amber-900/25 rounded-2xl border border-amber-900/25">
                <div className="grid gap-1 p-4 sm:grid-cols-[8rem_1fr] sm:gap-5">
                  ...
                  <dd className="text-sm text-amber-300/65">
                    <span className="font-mono text-amber-100/80">array</span> ·
                    required — the ordered parts of the observation.
                  </dd>
                </div>
                <div className="grid gap-1 border-t border-amber-900/25 p-4 sm:grid-cols-[8rem_1fr] sm:gap-5">
                  <dt className="font-mono text-sm text-sky-200">
                    parts[].type
                  </dt>
                  <dd className="text-sm text-amber-300/65">
                    ...
                    — identifies a text observation part.
                  </dd>
                </div>
                <div className="grid gap-1 border-t border-amber-900/25 p-4 sm:grid-cols-[8rem_1fr] sm:gap-5">
                  <dt className="font-mono text-sm text-sky-200">
                  ...
                  <dd className="text-sm text-amber-300/65">
                    <span className="font-mono text-amber-100/80">string</span>{" "}
                    · required — the text presented to the model.
                  </dd>
                </div>
              </dl>
            </div>
            ...
            <div className="mt-8">
              ...
              <pre className="mt-5 overflow-x-auto rounded-2xl border border-amber-900/25 bg-[#0b0908] p-5 text-xs leading-relaxed text-amber-200/80">
          ...
          <section className="p-6 sm:p-8">
            ...
            <pre className="mt-5 overflow-x-auto rounded-2xl border border-amber-900/25 bg-[#0b0908] p-5 text-xs leading-relaxed text-amber-200/80 sm:p-6">
