...
export default function DocsPage() {
  return (
    <DocsShell active="/docs" title="Build models that keep becoming.">
      <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="rounded-3xl border border-orange-500/30 bg-gradient-to-br from-orange-500/10 via-[#17100b] to-[#100b08] p-7 shadow-[0_0_80px_rgba(249,115,22,0.08)] sm:p-10">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-amber-200/65">
            Piro provides pretrained, stateful models that you can deploy, run,
            and build into your own applications through a model API designed to
            carry state forward.
          </p>
        </section>

        <section className="rounded-3xl border border-amber-900/30 bg-[#13100c] p-7 sm:p-8">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-amber-400/60">
            Quick start
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed text-amber-300/55">
            Invoke a shared model first, then move directly to private
            deployments, the API, or architecture docs when you are ready to go
            deeper.
          </p>
          <Link
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          {[
            [
              ...
              "Getting started",
              "Invoke the latest shared model, then deploy a private model when you need one.",
            ],
            [
              "/docs/api",
              "API",
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                <span
                  aria-hidden="true"
                  className="text-orange-300 transition-transform group-hover:translate-x-1"
                >
                  →
                </span>
              </div>
