      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 min-w-0 space-y-0.5">
          <div className="flex items-center gap-2">
            <svg
              className="w-4 h-4 text-amber-600/40 shrink-0"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.75"
              viewBox="0 0 24 24"
            >
              <path
                ...
                d="M3 7.5L12 3l9 4.5M3 7.5L12 12m-9-4.5v9L12 21m0-9l9-4.5m-9 4.5v9m9-13.5v9L12 21"
              />
            </svg>
          ...
          {repo.description && (
            <p className="text-[11px] text-amber-600/40 leading-relaxed truncate max-w-xs">
              {repo.description}
            </p>
          )}
        ...
        {rows.length === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-[280px] text-center">
            ...
            <p className="text-xs text-amber-600/40 mt-1 max-w-xs">
              Create one with{" "}
              <code className="font-mono text-amber-500/50">
                piro repos create &lt;id&gt; --name &lt;name&gt;
