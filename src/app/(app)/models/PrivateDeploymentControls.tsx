...
export default function PrivateDeploymentControls({
  deploymentId,
  disableAction,
  deleteAction,
}: {
    ...
    <div className="flex shrink-0 items-center gap-2">
      ...
      <form
        ...
        onSubmit={(event) => {
          if (
            !window.confirm(
              "Delete this private deployment? The deployment will be removed, but the model and its weights will be kept.",
            )
          ) {
